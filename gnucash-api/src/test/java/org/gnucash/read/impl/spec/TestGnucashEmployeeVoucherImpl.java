...
public class TestGnucashEmployeeVoucherImpl
{
  ...
  public void test03_1() throws Exception
  {
    ...
    assertEquals(230.0, ((SpecInvoiceCommon) vchSpec).getAmountWithoutTaxes().doubleValue(), ConstTest.DIFF_TOLERANCE);
  ...
  public void test04_1() throws Exception
  {
    ...
    LinkedList<GnucashTransaction> trxList = (LinkedList<GnucashTransaction>) vchSpec.getPayingTransactions();
    // ::TODO
